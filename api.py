...
def get_game_score(team_name):
    ...
    conn.close()
    if result:
        keys = ["gaime_id", "status", "home_team", "home_team_score", "away_team", "away_team_score"]
...
def home():
    return jsonify({
        'message': 'Welcom eto the NBA Scores API. User /score?team=<team_name> to fetch game scores'
    })
